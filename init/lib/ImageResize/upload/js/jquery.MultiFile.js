...
/*# AVOID COLLISIONS #*/
 ...
 $.extend($.MultiFile, {
  ...
  disableEmpty: function(klass){
   ...
   return $(o).each(function(){ this.disabled = true }).addClass(klass || 'mfD file');
  },
     ...
     if(this._MultiFile) return; this._MultiFile = true;
       ...
       MF.addSlave = function( slave, slave_count ){
        ...
        $(slave).change(function(){
          ...
          MF.list.before(newEle);//.append(newEle); - replace by spiritzzz - ýòó ñòðîêó ÿ ðàñêîììåíòèðîâàë
          //MF.wrapper.prepend(newEle);//.append(newEle); - replace by spiritzzz - à ýòó çàêîììåíòèðîâàë
