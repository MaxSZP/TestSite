...
for ($i = 0; $i < $files_count; $i++) {	
	...
	//		if ($_POST['orient']==0) {
			...
			if (is_dir("../../foto_prikol/".$_POST['id']."/galery/")) {
				
			if (file_exists("../../foto_prikol/".$_POST['id']."/galery/" .$new_name)){
				$name1 =  str_replace(".jpg","", $new_name);

				$new_name1 = $name1."_1".".jpg";
				if (file_exists("../../foto_prikol/".$_POST['id']."/galery/" .$new_name1)){
				$new_name1 = $name1.filemtime("../../foto_prikol/".$_POST['id']."/galery/".$new_name1).".jpg";
				}
		//		move_uploaded_file($new_tmp_name, "../../".$_POST['dir']."/gallery/".$_POST['desing']."/" . $new_name1);
      			$msg .= $new_name1;
				img_resize($new_tmp_name, "../../foto_prikol/".$_POST['id']."/galery/" . $new_name1, $width, $height,  90, 0x002c59, 0);
				img_resize($new_tmp_name, "../../foto_prikol/".$_POST['id']."/galery/thumb/" . $new_name1, $thumb_width, $thumb_height,  90, 0x002c59, 0);
			 $query_insert = "INSERT INTO `foto-prikol_foto` (`id`, `id_catalog`, `file`, `dir`, `orient`)  VALUES (NULL, '".$_POST['id']."', '".$new_name."', 'foto_prikol', '$orient')";
			$insert= mysql_query($query_insert, $base) or die(mysql_error());
				...
				$msg .=  $new_name;
				img_resize($new_tmp_name, "../../foto_prikol/".$_POST['id']."/galery/" . $new_name, $width, $height,  90, 0x002c59, 0);
				img_resize($new_tmp_name, "../../foto_prikol/".$_POST['id']."/galery/thumb/" .$new_name, $thumb_width, $thumb_height,  90, 0x002c59, 0);
			 $query_insert = "INSERT INTO `foto-prikol_foto` (`id`, `id_catalog`, `file`, `dir`, `orient`)  VALUES (NULL, '".$_POST['id']."', '".$new_name."', 'foto_prikol', '$orient')";
			$insert= mysql_query($query_insert, $base) or die(mysql_error());

			}
			} else {
			mkdir("../../foto_prikol/".$_POST['id']."/galery/", 0777);
			mkdir("../../foto_prikol/".$_POST['id']."/galery/thumb/", 0777);
    ...
    <?php Header("Location: ../base.php?id=11&dir=".$_POST['dir']."&idd=".$_POST['id']."&idupdatephoto=".$_POST['id']."");?>
